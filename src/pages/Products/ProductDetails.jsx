      ...
      <section className="mx-auto my-8 w-11/12 max-w-screen-xl">
        <div className="flex flex-col justify-between gap-4 sm:flex-row">
          ...
          <div className="space-x-4">
            <a
              href="https://www.figma.com/community/plugin/1460705789268746232/quickfill-design-faster-with-ready-content?ref=producthunt"
              target="_blank"
        ...
        <div className="mt-4">
          <p className="text-justify">
            QuickFill is a Figma plugin that streamlines your workflow with
            ready-to-use text and visual assets. Generate realistic text in 45+
            languages, access logos, avatars, flags, and social icons, and
            integrate Unsplash visuals—all to save UI/UX designers time.
          </p>
        </div>
